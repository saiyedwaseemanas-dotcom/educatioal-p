...
jobs:
  build-apk:
    ...
    steps:
      ...
      - name: Initialize or Re-sync Native Android Platform
        run: |
          if [ ! -f "android/build.gradle" ]; then
            echo "android/build.gradle not found! Cleaning partial directory and initializing clean platform..."
            rm -rf android
      ...
      - name: Configure Android SDK Location and Permissions
        run: |
